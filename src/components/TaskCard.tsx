...
const TaskCard = ({ task, deleteTaskCallBack,updateTaskCallBack }: TaskCardProps) => {
    ...
    <div className="card" key={taskData.id}>
      <div className="card-body d-flex">
        <div>
          ...
          <button onClick={() => setIsEditing(!isEditing)} className="btn btn-primary m-3">
            Update
          </button>
          <button
            onClick={() => {
        ...
        {isEditing && (
          <form onSubmit={(e)=> e.preventDefault()}>
            <div className="form-group">
              ...
              <textarea className="form-control m-1" value={taskData.description} rows={3}
